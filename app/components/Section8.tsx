...
export default function Section8() {
  return (
    <>
<div data-node-id="element_image_q805w0pboez" style={{"position":"absolute","left":"-2.2052951388888826px","top":"4942.576388888889px","width":"575.4915364583333px","height":"441.8791232638889px","zIndex":"0","opacity":"1","--miu-node-rotate":"0deg","transform":"rotate(var(--miu-node-rotate, 0deg))","overflow":"hidden","borderRadius":"0px"}}>
...
<div data-node-id="element_text_gk7yvcrhsdn" data-node-type="element_text" data-manual-sized="1" data-anim-preset="fadeInUp" data-anim-duration="3000" data-anim-delay="0" data-anim-easing="cubic-bezier(0.2, 0.8, 0.2, 1)" data-anim-loop="0" style={{"position":"absolute","left":"22.587239583333336px","top":"5188.939670138889px","width":"530.1848958333334px","height":"164px","zIndex":"0","opacity":"0","--miu-node-rotate":"0deg","transform":"rotate(var(--miu-node-rotate,0deg))","display":"block","textAlign":"center","fontFamily":"Lora, Georgia, 'Times New Roman', serif","fontSize":"18px","fontWeight":"200","fontStyle":"normal","color":"#928362","whiteSpace":"pre-wrap","paddingTop":"5px","paddingBottom":"5px"}}>
          ...
          thách để cùng nhau bước đến ngày trọng đại <br />– đám cưới của chúng
          mình.<br />Đám cưới này là lời cam kết chân thành, là sự bắt đầu của
          một chương mới – nơi chúng ta cùng vun đắp tổ ấm, cùng sẻ chia mọi vui
          buồn và cùng nắm tay nhau đi đến cuối con đường mang tên hạnh phúc.
        </div>
<div data-node-id="element_shape_hk4om4ex79t" data-anim-preset="rotateInDownLeft" data-anim-duration="3000" data-anim-delay="0" data-anim-easing="cubic-bezier(0.2, 0.8, 0.2, 1)" data-anim-loop="0" style={{"position":"absolute","left":"87.44431813675308px","top":"5423.735894097223px","width":"211.04159475429384px","height":"281.98381941565833px","zIndex":"0","opacity":"0","boxShadow":"0 10px 30px rgba(0, 0, 0, 0.15)","--miu-node-rotate":"-14.253931432707958deg","transform":"rotate(var(--miu-node-rotate, 0deg))"}}>
          <svg viewBox="0 0 100 100" preserveAspectRatio="none" width="100%" height="100%" style={{"display":"block","overflow":"visible"}}>
            <rect x="0" y="0" width="100" height="100" rx="0" ry="0" fill="#ffffff" stroke="none" strokeWidth="0"></rect>
          </svg>
        </div>
...
<div data-node-id="element_text_m9lbw89x79u" data-node-type="element_text" data-manual-sized="1" data-anim-preset="fadeInDown" data-anim-duration="3000" data-anim-delay="0" data-anim-easing="cubic-bezier(0.2, 0.8, 0.2, 1)" data-anim-loop="0" style={{"position":"absolute","left":"7.464843750000002px","top":"5804.014850554589px","width":"218.0963541666667px","height":"32px","zIndex":"0","opacity":"0","--miu-node-rotate":"0deg","transform":"rotate(var(--miu-node-rotate,0deg))","display":"block","textAlign":"right","fontFamily":"'Playfair Display', Georgia, 'Times New Roman', serif","fontSize":"24px","fontWeight":"400","fontStyle":"normal","textTransform":"uppercase","color":"#928362","whiteSpace":"pre-wrap","paddingTop":"5px","paddingBottom":"5px"}}>
          NINH GIANG
        </div>
<div data-node-id="element_text_n5zv153x79u" data-node-type="element_text" data-manual-sized="1" data-anim-preset="fadeInDown" data-anim-duration="3000" data-anim-delay="0" data-anim-easing="cubic-bezier(0.2, 0.8, 0.2, 1)" data-anim-loop="0" style={{"position":"absolute","left":"323.0842013888889px","top":"5474.987289790702px","width":"116.34830729166671px","height":"26px","zIndex":"0","opacity":"0","--miu-node-rotate":"0deg","transform":"rotate(var(--miu-node-rotate,0deg))","display":"block","textAlign":"left","fontFamily":"'Playfair Display', Georgia, 'Times New Roman', serif","fontSize":"20px","fontWeight":"400","fontStyle":"normal","color":"#928362","whiteSpace":"pre-wrap","paddingTop":"5px","paddingBottom":"5px"}}>
          Chú rể
        </div>
...
<div data-node-id="element_image_sdkqtj91c5n" data-anim-preset="fadeIn" data-anim-duration="3000" data-anim-delay="0" data-anim-easing="cubic-bezier(0.2, 0.8, 0.2, 1)" data-anim-loop="0" style={{"position":"absolute","left":"-0.5132378472222112px","top":"6099.58984375px","width":"575.1171875px","height":"110.39561631944444px","zIndex":"0","opacity":"0","--miu-node-rotate":"0deg","transform":"rotate(var(--miu-node-rotate, 0deg))","overflow":"hidden","borderRadius":"0px"}}>
          <div style={{"position":"relative","width":"100%","height":"100%"}}>
            <img src="./assets/ndasjdhjk123n213n12ljl.png" alt="" style={{"width":"100%","height":"100%","objectFit":"contain","objectPosition":"50% 50%","display":"block","transform":"scale(1, 1)","transformOrigin":"center","borderRadius":"0px"}} />
          </div>
        </div>
<div data-node-id="element_calendar_656b5wh1pz0" data-anim-preset="fadeIn" data-anim-duration="3000" data-anim-delay="0" data-anim-easing="cubic-bezier(0.2, 0.8, 0.2, 1)" data-anim-loop="0" style={{"position":"absolute","left":"18.43337673611113px","top":"6327.532335069444px","width":"532.0720486111111px","height":"297.146484375px","zIndex":"0","opacity":"0","--miu-node-rotate":"0deg","transform":"rotate(var(--miu-node-rotate, 0deg))","display":"flex","flexDirection":"column","color":"#928362","fontFamily":"","gap":"6px"}}>
          <div style={{"display":"grid","gridTemplateColumns":"repeat(7, 1fr)","gap":"4px","fontSize":"12px","opacity":"0.85","textTransform":"capitalize","height":"18px","alignItems":"center"}}>
